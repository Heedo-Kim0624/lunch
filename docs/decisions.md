...
- Use `rules-v2`: score all eligible foods, rotate ties, build a family-round-robin 24-item pool, and log conditional softmax probabilities; defer GNN and pgvector.
